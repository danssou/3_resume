export const navItems = [
  ...
  export const gridItems = [
  ...
  
    {
      ...
      titleClassName: "justify-center md:justify-start lg:justify-center items-start",
      img: "/b5.svg",
      spareImg: "/grid.svg",
    },
    {
  ...
  export const projects = [
    {
      ...
      link: "https://github.com/danssou/danssou.git",
    },
    {
      id: 2,
  ...
  export const testimonials = [
    {
      quote:
        "Collaborating with Kokouvi was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Kokouvi's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Kokouvi is the ideal partner.",
